...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    confirmationDate: Schema.Attribute.Date;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    playerStatus: Schema.Attribute.Enumeration<
      [
        '\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D',
        '\u041D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D',
      ]
    > &
      Schema.Attribute.DefaultTo<'\u041D\u0435 \u043F\u043E\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043D'>;
    points: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
      ...
      Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    tier: Schema.Attribute.Enumeration<['T1', 'T2', 'T3', 'T4', 'T5']> &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'T5'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    updateNote: Schema.Attribute.Text;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
...
export interface ApiUpdateUpdate extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u041E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F \u0442\u0438\u0440\u043B\u0438\u0441\u0442\u0430';
    displayName: 'Update';
    pluralName: 'updates';
    singularName: 'update';
  };
